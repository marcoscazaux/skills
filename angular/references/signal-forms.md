...
<form (submit)="onSubmit(); $event.preventDefault()">
  ...
  <section>
    ...
    <label>
      ...
      <input
        type="email"
        [formField]="bookingForm.personalInfo.email" />
    ...
    <label>
      ...
      <input
        type="number"
        [formField]="bookingForm.personalInfo.age" />
  ...
  <section>
    ...
    <label>
      ...
      <input
        type="date"
        [formField]="bookingForm.tripDetails.launchDate" />
